...
-- | Defines the oneOf schema located at @components.schemas.Dog.properties.weirdUri.oneOf@ in the specification.
-- 
-- 
data DogWeirdUriVariants =
   DogWeirdUriText Data.Text.Internal.Text
  | DogWeirdUriText Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DogWeirdUriVariants
    where {toJSON (DogWeirdUriText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (DogWeirdUriText a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON DogWeirdUriVariants
    where {parseJSON val = case (DogWeirdUriText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((DogWeirdUriText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
